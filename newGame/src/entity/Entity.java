...
public class Entity {
	...
	public void dropItem(Entity droppedItem) {
		for (int i  = 0; i < gp.obj[1].length; i++) {
			if (gp.obj[gp.currentMap] [i] == null) {
				...
				gp.obj[gp.currentMap] [i].worldX = worldX; 		//the dead monster coordinate
	...
	public void update() {
		...
		if (shootAvailableCounter < 30 ) {
			...
			//System.out.println(shootAvailableCounter);
		}
	};
	...
	public void draw(Graphics2D g2) {
		...
		if (type == 2 && hpBarOn == true) {
			...
			g2.setColor(new Color(35,35,25));
			g2.fillRect(screenX - 1, screenY - 16, gp.tileSize + 1 , 7);
